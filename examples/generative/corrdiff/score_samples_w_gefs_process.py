...
def process(i, forecast, truth, pred, n_ensemble, is_pred = True):
    ...
    if not is_pred:
        ...
        plt.subplot(5,2,1)
        plt.imshow(truth_slice.values[0,0,2], vmin=250, vmax=310)
        plt.title("hrrr t2m",fontsize=20)
        plt.subplot(5,2,2)
        plt.imshow(pred_slice.values[0,0,0,2], vmin=250, vmax=310)
        plt.title("gefs t2m",fontsize=20)
        plt.subplot(5,2,3)
        plt.imshow(np.log(truth_slice.values[0,0,3]+1e-6), vmin=-3, vmax=3)
        plt.title("hrrr precip",fontsize=20)
        plt.subplot(5,2,4)
        plt.imshow(np.log(pred_slice.values[0,0,0,3]+1e-6), vmin=-3, vmax=3)
        plt.title("gefs precip",fontsize=20)
        plt.subplot(5,2,5)
        plt.imshow(truth_slice.values[0,0,4], vmin=0, vmax=1)
        plt.title("hrrr cat_snow",fontsize=20)
        plt.subplot(5,2,6)
        plt.imshow(pred_slice.values[0,0,0,4], vmin=0, vmax=1)
        plt.title("gefs cat_snow",fontsize=20)
        plt.subplot(5,2,7)
        plt.imshow(truth_slice.values[0,0,6], vmin=0, vmax=1)
        plt.title("hrrr cat_freez",fontsize=20)
        plt.subplot(5,2,8)
        plt.imshow(pred_slice.values[0,0,0,6], vmin=0, vmax=1)
        plt.title("gefs cat_freez",fontsize=20)
        plt.subplot(5,2,9)
        plt.imshow(truth_slice.values[0,0,7], vmin=0, vmax=1)
        plt.title("hrrr cat_rain",fontsize=20)
        plt.subplot(5,2,10)
        plt.imshow(pred_slice.values[0,0,0,7], vmin=0, vmax=1)
        plt.title("gefs cat_rain",fontsize=20)
        plt.savefig(f"{i}{forecast}.png")  
