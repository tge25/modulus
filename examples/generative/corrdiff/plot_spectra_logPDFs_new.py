...
intera5_rad_bins, intera5_rad_pdf = load_dist(prediction_intera5.maximum_radar_reflectivity, bins)
...
ax0.loglog(rf_ke_freq, rf_ke_spec, label="Paper Baseline", color=wong_palette[1], linewidth=1)
ax0.loglog(reg_ke_freq, reg_ke_spec, label="Modulus CorrDiff", color=wong_palette[2], linewidth=1)
ax0.loglog(
    intera5_ke_freq,
    intera5_ke_spec,
...
ax2.loglog(wrf_rad_freq, wrf_rad_spec, label="target", color=wong_palette[4], linewidth=5)
ax2.loglog(rf_rad_freq, rf_rad_spec, label="Paper Baseline", color=wong_palette[1], linewidth=1)
ax2.loglog(reg_rad_freq, reg_rad_spec, label="Modulus Patched CorrDiff", color=wong_palette[2], linewidth=1)
ax2.loglog(
    intera5_rad_freq,
    intera5_rad_spec,
    label="Modulus CorrDiff",
    color=wong_palette[3],
    linewidth=1,
)
ax2.loglog(
...
plt.tight_layout()
plt.savefig("./spectra_and_distributions_full_val_pos.png")
